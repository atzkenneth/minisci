...
def get_heat(p, name, categories=2):
    ...
    ys = data11[1] + data12[1] + data13[1] + data14[1]
    ps = data11[2] + data12[2] + data13[2] + data14[2]
    ...
    ys = data21[1] + data22[1] + data23[1] + data24[1]
    ps = data21[2] + data22[2] + data23[2] + data24[2]
    ps = [p * 100 for p in ps]
    ps = [p if p < 100 else 100 for p in ps]
    ps = [p if p > 0 else 0 for p in ps]
    ys = [y * 100 for y in ys]
    ...
    ys = data31[1] + data32[1] + data33[1] + data34[1]
    ps = data31[2] + data32[2] + data33[2] + data34[2]
    ps = [p * 100 for p in ps]
    ps = [p if p < 100 else 100 for p in ps]
    ps = [p if p > 0 else 0 for p in ps]
    ys = [y * 100 for y in ys]
